...
class Customer(models.Model):
    ...
    year = models.IntegerField(choices=[(year, year) for year in range(start_year, current_year + 1)])
    ...
    repair_fix = models.ManyToManyField('Repair', blank=True, related_name='customers_repairs')
    ...
    def _set_car_model_choices(self):
        self.car_model_choices = []
        if self.car_make:
            car_models = {
                'Audi': [('A1', 'A1'), ('A2', 'A2'), ('A3', 'A3'), ('A5', 'A5'), 
                         ('Q3', 'Q3'), ('Q5', 'Q5'), ('Q7', 'Q7')],
