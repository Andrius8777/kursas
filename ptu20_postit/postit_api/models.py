...
class UserModel(models.Model):      #bendra klase visoms kitoms, kad nereiktu rasyt created ir t.t...
...
class Post(UserModel):                                           #panaudojam is auksciau aprasytos klases UserModel
